...
#![allow(warnings)]
pub const MPR_DEV: mpr_type = mpr_type::MPR_DEV;
pub const MPR_SIG_IN: mpr_type = mpr_type::MPR_SIG_IN;
pub const MPR_SIG_OUT: mpr_type = mpr_type::MPR_SIG_OUT;
pub const MPR_SIG: mpr_type = mpr_type::MPR_SIG;
pub const MPR_MAP_IN: mpr_type = mpr_type::MPR_MAP_IN;
pub const MPR_MAP_OUT: mpr_type = mpr_type::MPR_MAP_OUT;
pub const MPR_MAP: mpr_type = mpr_type::MPR_MAP;
pub const MPR_OBJ: mpr_type = mpr_type::MPR_OBJ;
pub const MPR_LIST: mpr_type = mpr_type::MPR_LIST;
pub const MPR_GRAPH: mpr_type = mpr_type::MPR_GRAPH;
pub const MPR_BOOL: mpr_type = mpr_type::MPR_BOOL;
pub const MPR_TYPE: mpr_type = mpr_type::MPR_TYPE;
pub const MPR_DBL: mpr_type = mpr_type::MPR_DBL;
pub const MPR_FLT: mpr_type = mpr_type::MPR_FLT;
pub const MPR_INT64: mpr_type = mpr_type::MPR_INT64;
pub const MPR_INT32: mpr_type = mpr_type::MPR_INT32;
pub const MPR_STR: mpr_type = mpr_type::MPR_STR;
pub const MPR_TIME: mpr_type = mpr_type::MPR_TIME;
pub const MPR_PTR: mpr_type = mpr_type::MPR_PTR;
pub const MPR_NULL: mpr_type = mpr_type::MPR_NULL;
#[repr(u32)]
